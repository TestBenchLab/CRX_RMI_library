...
class RMILibrary:
  ...
  def rmi_get_status(self,verbose=True):
    ...
    try:
      ...
      if error_id is None:
        ...
        if verbose:
          error_str = self.get_error_string(error_id)
          LOGGER.warning("RMI_GETSTATUS successful") if request_successful else LOGGER.error(f"RMI_GETSTATUS failed: {error_str}")
  ...
  def rmi_initialize(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_INITIALIZE successful") if request_successful else LOGGER.error(f"RMI_INITIALIZE failed: {error_str}")
        return request_successful, response
  ...
  def rmi_abort(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_ABORT successful") if request_successful else LOGGER.error(f"RMI_ABORT failed: {error_str}")
        return response
  ...
  def rmi_reset(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_RESET successful") if request_successful else LOGGER.error(f"RMI_RESET failed: {error_str}")
        return response
  ...
  def rmi_pause(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_PAUSE successful") if request_successful else LOGGER.error(f"RMI_PAUSE failed: {error_str}")
        return response
  ...
  def rmi_continue(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        LOGGER.warning("RMI_CONTINUE successful") if request_successful else LOGGER.error(f"RMI_CONTINUE failed: {error_str}")
        return response
  ...
  def rmi_set_uf_ut(self,uf:int, ut:int, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_SET_UF_UT successful") if request_successful else LOGGER.error(f"RMI_SET_UF_UT failed: {error_str}")
        return request_successful, response
  ...
  def rmi_read_uf_data(self, uf:int, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_READ_UF_DATA successful") if request_successful else LOGGER.error(f"RMI_READ_UF_DATA failed: {error_str}")
        return response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_write_uf_data(self, uf_number:int, frame:dict, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_WRITE_UF_DATA successful") if request_successful else LOGGER.error(f"RMI_WRITE_UF_DATA failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_read_ut_data(self, ut:int, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_READ_UT_DATA successful") if request_successful else LOGGER.error(f"RMI_READ_UT_DATA failed: {error_str}")
        return response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_write_ut_data(self, ut_number:int, frame:dict, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_WRITE_UT_DATA successful") if request_successful else LOGGER.error(f"RMI_WRITE_UT_DATA failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_write_d_out(self, port_number:int, port_value):
    a = 0
    #TODO
  ...
  def rmi_read_cartesian_position(self, group=1):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_READ_CARTESIAN_POSITION successful") if request_successful else LOGGER.error(f"RMI_READ_CARTESIAN_POSITION failed: {error_str}")
        return request_successful, response
  ...
  def rmi_set_override(self, value:int):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_SET_OVERRIDE successful") if request_successful else LOGGER.error(f"RMI_SET_OVERRIDE failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_get_uf_ut(self, group=1):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_GET_UF_UT successful") if request_successful else LOGGER.error(f"RMI_GET_UF_UT failed: {error_str}")
        return request_successful, response
  ...
  def rmi_read_position_register(self, register:int, group=1):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_READ_PR successful") if request_successful else LOGGER.error(f"RMI_READ_PR failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_write_position_register(self, register:int, config:dict, position:dict, group=1):
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_WRITE_PR successful") if request_successful else LOGGER.error(f"RMI_WRITE_PR failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_read_tcp_speed(self):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_READ_TCP_SPEED successful") if request_successful else LOGGER.error(f"RMI_READ_TCP_SPEED failed: {error_str}")
        return request_successful, response
  ...
  def rmi_wait_din(self, port_number:int, port_value:str):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_WAIT_DIN successful") if request_successful else LOGGER.error(f"RMI_WAIT_DIN failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_set_u_frame(self, frame_number:int):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_SET_U_FRAME successful") if request_successful else LOGGER.error(f"RMI_SET_U_FRAME failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_set_u_tool(self, tool_number:int):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_SET_U_TOOL successful") if request_successful else LOGGER.error(f"RMI_SET_U_TOOL failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_wait_time(self, waiting_time:float):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_WAIT_TIME successful") if request_successful else LOGGER.error(f"RMI_WAIT_TIME failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_set_payload(self, schedule_number:int):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_SET_PAYLOAD successful") if request_successful else LOGGER.error(f"RMI_SET_PAYLOAD failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_call(self, program_name:str):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_CALL successful") if request_successful else LOGGER.error(f"RMI_CALL failed: {error_str}")
        return request_successful, response
  ...
  def rmi_linear_motion(self, config:dict, position:dict, speed_type:str, speed, term_type:str, term_value):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_LINEAR_MOTION successful") if request_successful else LOGGER.error(f"RMI_LINEAR_MOTION failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_linear_relative(self, config:dict, position:dict, speed_type:str, speed, term_type:str, term_value, optionals:dict= {}):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_LINEAR_RELATIVE successful") if request_successful else LOGGER.error(f"RMI_LINEAR_RELATIVE failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
  ...
  def rmi_joint_motion(self, config:dict, position:dict, speed_type:str, speed, term_type:str, term_value):
    ...
    try:
      ...
      if error_id is None:
        ...
        request_successful = error_id == 0
        error_str = self.get_error_string(error_id)
        LOGGER.warning("RMI_JOINT_MOTION successful") if request_successful else LOGGER.error(f"RMI_JOINT_MOTION failed: {error_str}")
        return request_successful, response
    except AssertionError as ae: LOGGER.error(ae)
